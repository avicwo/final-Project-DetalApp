...
import { FormControl, InputGroup, Row, Col, Accordion, Image, Button, Modal, Card, Form } from 'react-bootstrap';
...
class PatiantForm extends React.Component {
    constructor(props) {
        ...
        this.toggleTopLeftTeath = this.toggleTopLeftTeath.bind(this);
        this.toggleTopRightTeath = this.toggleTopRightTeath.bind(this);
        this.toggleButtomLeftTeath = this.toggleButtomLeftTeath.bind(this);
        this.toggleButtomRightTeath = this.toggleButtomRightTeath.bind(this);
        ...
        this.topLeftTeath = React.createRef();
        this.topRightTeath = React.createRef();
        this.buttomLeftTeath = React.createRef();
        this.buttomRightTeath = React.createRef();
    ...
    customToggle(eventKey) {
        console.log(eventKey.currentTarget.innerHTML)
    }
    ...
    createForm() {
        const formDetailst = {
            ...
            topLeftTeath: this.topLeftTeath.current.checked,
            topRightTeath: this.topRightTeath.current.checked,
            buttomLeftTeath: this.buttomLeftTeath.current.checked,
            buttomRightTeath: this.buttomRightTeath.current.checked,
    ...
    toggleTopLeftTeath() {
        if (this.topLeftTeath.current.checked) {
            this.t28.current.checked = true
            this.t27.current.checked = true
            this.t26.current.checked = true
            this.t25.current.checked = true
    ...
    toggleButtomRightTeath() {
        if (this.buttomRightTeath.current.checked) {
            this.t41.current.checked = true
            this.t42.current.checked = true
            this.t43.current.checked = true
            this.t44.current.checked = true
    ...
    toggleTopRightTeath() {
        if (this.topRightTeath.current.checked) {
            this.t11.current.checked = true
            this.t12.current.checked = true
            this.t13.current.checked = true
            this.t14.current.checked = true
    ...
    toggleButtomLeftTeath() {
        if (this.buttomLeftTeath.current.checked) {
            this.t38.current.checked = true
            this.t37.current.checked = true
            this.t36.current.checked = true
            this.t35.current.checked = true
        ...
        return (
            <div className="container" >
                ...
                <div className="patiantDetailsForm">
                    ...
                    >
                        <Card>
                            <Accordion.Toggle as={Card.Header} eventKey="0" className="plusSign">
                                <div>פרטי מטופל</div>
                                <div>+</div>
                            </Accordion.Toggle>
                        ...
                        <Card>
                            <Accordion.Toggle onClick={this.customToggle} as={Card.Header} eventKey="1" className="plusSign">
                                <div>צילומי שיניים</div>
                                <div >+</div>
                            ...
                            <Accordion.Collapse eventKey="1">
                                <Form className="basicFormStructure">
                                    <Row>
                                        <Col className="removeColPadding">
                                            <div >
                                                <Form.Check inline ref={this.ctType_isPanoramic} label="פנורמי" type="checkbox" id={`inline-checkbox-1`} />
                                            </div>
                                            <div>
                                                <Form.Check inline ref={this.ctType_isStatus} label="סטטוס" type="checkbox" id={`inline-checkbox-2`} />
                                            </div>
                                            <div>
                                                <Form.Check inline ref={this.ctType_isStatusParallel} label="סטטוס מקבילית" type="checkbox" id={`inline-checkbox-3`} />
                                            </div>
                                        ...
                                        <Col>
                                            ...
                                            <div >
                                                <Form.Check name="formx2Vsx4" inline ref={this.ctType_isPanoramic} label="x2" type="radio" id={`inline-radio-4`} />
                                                <Form.Check className="x4padding" name="formx2Vsx4" inline ref={this.ctType_isStatus} label="x4" type="radio" id={`inline-radio-5`} />
                                            </div>

                                            <div>
                                                <Form.Check name="formnormVsVertical" inline ref={this.ctType_isPanoramic} label="רגיל" type="radio" id={`inline-radio-6`} />
                                                <Form.Check name="formnormVsVertical" inline ref={this.ctType_isStatus} label="ורטיקאלי" type="radio" id={`inline-radio-7`} />
                        ...
                        <Card>
                            <Accordion.Toggle as={Card.Header} eventKey="2" className="plusSign">
                            ...
                            <Accordion.Collapse eventKey="2">
                                ...
                                <Card.Body>
                                    <Row>
                                        <Col>
                                            <div>
                                                <Form.Check inline ref={this.ortho_cephalometric_side} label=" צפלומטרי צדדי" type="checkbox" id={`inline-checkbox-1`} />
                                            </div>
                                            <div>

                                                <Form.Check inline ref={this.ortho_computerized_tomography} label="שרטוט ואנליזה ממוחשבת" type="checkbox" id={`inline-checkbox-2`} />
                                            </div>
                                            <div>

                                                <Form.Check inline ref={this.ortho_diagnostic_setup} label=" מטבעי לימוד אבחנתיים" type="checkbox" id={`inline-checkbox-3`} />
                                            </div>
                                            <div>

                                                <Form.Check inline ref={this.orth_facial_type} label=" תמונות פנים ושיניים  " type="checkbox" id={`inline-checkbox-3`} />
                                            </div>
                                        </Col>
                                    </Row>
                                </Card.Body>
                        ...
                        <Card>
                            <Accordion.Toggle as={Card.Header} eventKey="3" className="plusSign">

                                <div>צילומים פריאפיקליים</div>
                                <div>+</div>
                            ...
                            <Accordion.Collapse eventKey="3">
                                ...
                                <div className="">
                                    ...
                                    <div className="positionCenter">
                                        <div >
                                            <div className="">
                                                <input ref={this.topLeftTeath} onChange={this.toggleTopLeftTeath} type="checkbox"></input>
                                                <lable>שמאל עליון</lable>
                                            </div>
                                            <div className="">
                                                <input ref={this.buttomLeftTeath} onChange={this.toggleButtomLeftTeath} type="checkbox"></input>
                                                <lable>שמאל תחתון</lable>
                                            </div>
                                        </div>
                                        <div>
                                            <div className="">
                                                <input ref={this.topRightTeath} onChange={this.toggleTopRightTeath} type="checkbox"></input>
                                                <lable>ימין עליון</lable>
                                            </div>
                                            <div className="">
                                                <input ref={this.buttomRightTeath} onChange={this.toggleButtomRightTeath} type="checkbox"></input>
                                                <lable>ימין תחתון</lable>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="allTeathSelection" >
                                        ...
                                        <div className="rightSide">
                                            ...
                                            <div className="textAlignL"> R</div>
                        ...
                        <Card>
                            <Accordion.Toggle as={Card.Header} eventKey="4" className="plusSign">
                        ...
                        <Card>
                            <Accordion.Toggle as={Card.Header} eventKey="5" className="plusSign">
                            ...
                            <Accordion.Collapse eventKey="5">
                                <Card.Body>
                                    <div className="alignTeathNum">
                                        <InputGroup>
                                            <InputGroup>
                                                <InputGroup.Text>רשום כאן:</InputGroup.Text>
                                            </InputGroup>
